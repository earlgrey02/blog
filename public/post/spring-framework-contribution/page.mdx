...
![](/post/spring-framework-contribution/1.png)

저 또한 해당 코드를 커밋하고 PR을 작성하였습니다.

![](/post/spring-framework-contribution/2.png)
...
![](/post/spring-framework-contribution/3.png)

이렇게 피드백을 반영한 제 코드를 추가로 커밋하고 댓글을 남겼습니다.

![](/post/spring-framework-contribution/4.png)
