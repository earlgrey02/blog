---
title: MongoDB에서의 트랜잭션 내 비동기 처리 문제
description: 비동기 처리가 MongoDB의 트랜잭션에 미치는 영향
date: 2024-05-20
tags: [Kotlin, Spring, MongoDB]
---

이번에 Spring WebFlux와 MongoDB를 함께 쓰면서 간헐적으로 트랜잭션이 실패하는 문제를 겪었는데요.
...
![](/post/mongodb-async-transaction/1.png)
...
![](/post/mongodb-async-transaction/2.png)
...
![](/post/mongodb-async-transaction/3.svg)
...
![](/post/mongodb-async-transaction/4.svg)
...
![](/post/mongodb-async-transaction/5.png)
